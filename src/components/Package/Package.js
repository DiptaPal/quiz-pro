...
const Package = () => {
    return (
        <div>
            <div className="px-4 py-16 mx-auto max-w-xs sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    ...
                    <span className="relative inline-block">
                        ...
                        <span className="relative text-indigo-500">Choose your best plan</span>
                    </span>
                    </h2>
                </div>
                <div className="grid max-w-md gap-10 row-gap-5 lg:max-w-screen-lg sm:row-gap-10 lg:grid-cols-3 xl:max-w-screen-lg sm:mx-auto">
                    ...
                    <div className="text-center text-indigo-500">
                        ...
                        <div className="text-indigo-500">Everything in Free</div>
                        <div className="text-indigo-500">7 Quiz Tests</div>
                        <div className="text-indigo-500">8 Assignments </div>
                        </div>
                    </div>
                    <div>
                        <button
                        className="inline-flex items-center justify-center w-full h-12 px-6 mt-6 font-medium tracking-wide transition duration-700 bg-indigo-500 text-white  rounded shadow-md hover:bg-blue-700 focus:shadow-outline focus:outline-none"
                        >
                        Start for free
                        </button>
                    </div>
                    </div>
                    <div className="relative flex flex-col justify-between p-8 transition-shadow duration-300 bg-white border border-indigo-500 rounded shadow-sm sm:items-center hover:shadow border-deep-purple-accent-400">
                    <div className="absolute inset-x-0 top-0 flex justify-center -mt-3">
                        <div className="inline-block px-3 py-1 text-xs font-medium tracking-wider bg-indigo-500 text-white uppercase rounded bg-deep-purple-accent-400">
                        Most Popular
                        </div>
                    </div>
                    <div className="text-center text-indigo-500">
                        ...
                        <div className="text-indigo-500">/ mo</div>
                        </div>
                        <div className="mt-2 space-y-3">
                        <div className="text-indigo-500">10 Quiz Test</div>
                        <div className="text-indigo-500">10 Assignment</div>
                        <div className="text-indigo-500">CV Guideline</div>
                        </div>
                    </div>
                    <div>
                        <button
                    ...
                    <div className="text-center text-indigo-500">
                        ...
                        <div className="mt-2 space-y-3">
                        <div className="text-indigo-500">15 Quiz Tests</div>
                        <div className="text-indigo-500">15 Assignments</div>
                        <div className="text-indigo-500">Resume Build-up</div>
                        <div className="text-indigo-500">24/7 Support</div>
                        </div>
                    </div>
                    <div>
                        <button
            ...
            <div>
                <section className="p-6 text-indigo-500">
                    <div className="container p-4 mx-auto text-center">
                        <h2 className="text-3xl font-bold border-b-4 border-indigo-500 pb-2 w-60 mx-auto mb-4">Trusted Partner</h2>
                    </div>
                    <div className="container flex flex-wrap justify-center mx-auto">
                        <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="fill-current w-14 h-14 text-indigo-500">

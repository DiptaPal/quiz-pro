    ...
    return (
        <div>
            <div className='text-lg text-start'>
                <label 
                htmlFor={id}
                className= {`border border-indigo-500 py-2 px-3 rounded-md shadow-md mb-3 flex justify-center items-center cursor-pointer ${isSelected ? `${isCorrect ? 'bg-green-500' : 'bg-red-500 text-white'}` : 'bg-none'}`}
                >

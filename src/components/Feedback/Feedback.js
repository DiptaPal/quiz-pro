        ...
        <div className='bg-indigo-50 my-40'>
            <section>
                <div className="mx-auto max-w-full px-4 py-8 sm:px-6 lg:px-24 text-center">
                    ...
                    <blockquote>
                        <header className="sm:flex sm:items-center justify-center">
                        <div className="-ml-1 flex">
                            <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 text-yellow-400"
                        ...
                        It is great that we are trying our best, but don’t stop here – keep pushing ourself to get even better results! Try to improve our skill by slowing down and focusing on every single letter.
                        </p>
                    ...
                    <blockquote>
                        ...
                        <footer className="mt-4">
                        <p className="text-xs text-gray-500">Thomas Lio - 24th April, 2022</p>
                        </footer>
                    </blockquote>
                    ...
                    <blockquote>
                        ...
                        <footer className="mt-4">
                        <p className="text-xs text-gray-500">Amber Heard- 13th October, 2022</p>
                        </footer>
                    </blockquote>
                    </div>
                </div>
